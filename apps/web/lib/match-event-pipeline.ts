...
type MatchEventContext = {
  ...
  pitchZone?: string;
  pitchLane?: string;
  pitchSide?: "own" | "opp" | "neutral";
  logEventType?: string;
};

type MatchEventPostBody = CreateMatchEventInput & {
...
export function buildMatchEventPostBody(
  ...
  input: Omit<CreateMatchEventInput, "matchId"> & { context?: MatchEventContext },
): MatchEventPostBody {
  const clockLabel =
